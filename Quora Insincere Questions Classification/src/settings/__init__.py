...
# LOGGER's
LOGGER_DEBUG_FILE = '/content/drive/My Drive/sumon/Kaggle-Competitions/Quora Insincere Questions Classification/src/logs/debug.log'
LOGGER_INFO_FILE = '/content/drive/My Drive/sumon/Kaggle-Competitions/Quora Insincere Questions Classification/src/logs/info.log'
LOGGER_ERROR_FILE = '/content/drive/My Drive/sumon/Kaggle-Competitions/Quora Insincere Questions Classification/src/logs/error.log'
